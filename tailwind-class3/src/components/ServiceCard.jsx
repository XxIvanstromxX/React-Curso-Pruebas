export default function ServiceCards({ title, description }) {
    return (
        <div className="bg-white/30 dark:bg-white/5 p-6 rounded-2xl shadow-md hover:shadow-lg transition-all duration-300 border border-white/30 dark:border-white/10 hover:-translate-y-1">
